...
// Текст для рассылки
const MESSAGE_TEXT = `✨ Магия начинается с одного фото…
Загружаешь старый снимок — и уже через пару минут он меняется на глазах:
появляется мягкая улыбка, оживает взгляд, в движении чувствуется тепло человека, которого так не хватало.

❤️ Это намного больше, чем просто изображение.
Это эмоция, воспоминание, которое снова становится живым и способно тронуть до глубины души.

🎁 Попробуй прямо сейчас —
Нажмите кнопку «Оживить фото» — или просто напишите любой текст, и кнопка появится автоматически.`;

// URL видео
const VIDEO_URL = 'https://storage.yandexcloud.net/vividus/service/broadcast6.mp4';
const VIDEO_CACHE_PATH = path.join(__dirname, 'uploads', 'temp', 'broadcast6.mp4');
