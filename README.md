...
Админ-панель доступна по адресу: `http://bots-panel.re-poizon.ru`

**Доступ:**
- Только для пользователей: `in_a_state_of_flux`, `pronewa`
- Или пользователей с telegram_id из `ADMIN_TELEGRAM_IDS`
...
- ✏️ Изменение количества генераций у пользователей
